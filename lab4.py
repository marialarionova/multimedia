...
def main():
    ...
    add_note(sample_rate, audio, duration_milliseconds=100)
    add_note(sample_rate, audio, notes_in_freq['E4'], 500)
    add_note(sample_rate, audio, duration_milliseconds=100)
    ...
    add_note(sample_rate, audio, duration_milliseconds=100)
    add_note(sample_rate, audio, notes_in_freq['D4'], 750)
    add_note(sample_rate, audio, duration_milliseconds=250)
    add_note(sample_rate, audio, notes_in_freq['G4'], 250)
    add_note(sample_rate, audio, duration_milliseconds=100)
    add_note(sample_rate, audio, notes_in_freq['G4'], 250)
    add_note(sample_rate, audio, duration_milliseconds=100)
    ...
    add_note(sample_rate, audio, notes_in_freq['G4'], 250)
    add_note(sample_rate, audio, duration_milliseconds=100)
    add_note(sample_rate, audio, notes_in_freq['C5'], 250)
    add_note(sample_rate, audio, duration_milliseconds=100)
    add_note(sample_rate, audio, notes_in_freq['H4'], 250)
    add_note(sample_rate, audio, duration_milliseconds=100)
    add_note(sample_rate, audio, notes_in_freq['D5'], 250)
    add_note(sample_rate, audio, duration_milliseconds=100)
    add_note(sample_rate, audio, notes_in_freq['C5'], 750)
    add_note(sample_rate, audio, duration_milliseconds=250)
    ...
    add_note(sample_rate, sample, duration_milliseconds=100)
    add_note(sample_rate, sample, notes_in_freq['E5'], 500)
    add_note(sample_rate, sample, duration_milliseconds=100)
    ...
    add_note(sample_rate, sample, duration_milliseconds=100)
    add_note(sample_rate, sample, notes_in_freq['D5'], 750)
    add_note(sample_rate, sample, duration_milliseconds=250)
    add_note(sample_rate, sample, notes_in_freq['G5'], 250)
    add_note(sample_rate, sample, duration_milliseconds=100)
    add_note(sample_rate, sample, notes_in_freq['G5'], 250)
    add_note(sample_rate, sample, duration_milliseconds=100)
    ...
    add_note(sample_rate, sample, duration_milliseconds=100)
    add_note(sample_rate, sample, notes_in_freq['H5'], 250)
    add_note(sample_rate, sample, duration_milliseconds=100)
    add_note(sample_rate, sample, notes_in_freq['D6'], 250)
    add_note(sample_rate, sample, duration_milliseconds=100)
    add_note(sample_rate, sample, notes_in_freq['C6'], 750)
    add_note(sample_rate, sample, duration_milliseconds=250)
